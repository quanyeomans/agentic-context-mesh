...
## Current state — v2026.4.18

**NDCG@10 0.845** on a 350-case benchmark with graded relevance gold labels (TREC-DL 0/1/2 rubric). **Hit@5 0.969** — a relevant document in the top 5 for 97% of queries. Phase 3 gate passed (weighted total 0.824 ≥ 0.75).
...
**Benchmark category breakdown (350-case suite, NDCG@10):**

| Category | NDCG@10 | Notes |
|---|---|---|
| entity | 0.869 | Neo4j entity boost, alias resolution |
| procedural | 0.872 | Path-pattern re-rank active |
| recall | 0.848 | Hybrid BM25 + vector |
| conceptual | 0.781 | Semantic intent routing |
| temporal | 0.794 | Date-aware chunking + chunk_date boost |
| multi_hop | 0.752 | QueryPlanner functional |
| **Overall** | **0.845** | Hit@5 0.969, MRR@10 0.764 |
