...
Path mappings:
  episodic           → /data/workspaces/<agent>/memory/<date>.md
  procedural-rule    → /data/obsidian-vault/04-Agent-Knowledge/<agent>/rules.md
  procedural-pattern → /data/obsidian-vault/04-Agent-Knowledge/<agent>/patterns.md
  semantic-decision  → /data/obsidian-vault/04-Agent-Knowledge/<agent>/decisions.md
  semantic-fact      → /data/obsidian-vault/04-Agent-Knowledge/<agent>/facts.md
  entity             → /data/obsidian-vault/04-Agent-Knowledge/entities/<type>/<slug>.md
"""
...
def resolve_target_path(
    ...
    Args:
        ...
        entity_slug:         Slug for entity file (e.g. "alex-jordan").
