...
Entity sources:
  ...
  Fallback: /data/obsidian-vault/04-Agent-Knowledge/shared/wikilink-entity-index.md
"""
...
DEFAULT_BOOTSTRAP_PATH = "/data/obsidian-vault/04-Agent-Knowledge/shared/wikilink-entity-index.md"
...
class WikiEntity:
    ...
    vault_path: str  # e.g. "02-Areas/Work/Clients/AcmeHealth/"
    link: str  # e.g. "[[AcmeHealth]]" or "[[BurgerPalace|Burger Palace]]"
    entity_type: str  # client, person, project, framework, etc.
...
#   | AcmeHealth | `[[AcmeHealth]]` | `02-Areas/Work/Clients/AcmeHealth/` |
...
def _extract_aliases(entity_name: str, link: str) -> list[str]:
    ...
    For [[BurgerPalace|Burger Palace]], the display text 'Burger Palace' is an alias.
    ...
    if not m:
        return aliases
    target = m.group(1)  # e.g. "BurgerPalace"
    display = m.group(2)  # e.g. "Burger Palace" or None
