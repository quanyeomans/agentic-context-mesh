"""
mnemosyne timeline — Temporal query rewriting + date-aware retrieval.

Usage:
  mnemosyne timeline <query> [--since YYYY-MM-DD] [--until YYYY-MM-DD] [--limit N]
  mnemosyne timeline --help

Examples:
  mnemosyne timeline "what was completed last week on Mnemosyne"
  mnemosyne timeline "what happened in March 2026" --since 2026-03-01 --until 2026-03-31
  mnemosyne timeline "recent Bower Bird changes" --limit 10
"""
...
def main(argv: list[str] | None = None) -> None:
    """Entry point for `mnemosyne timeline`."""
    parser = argparse.ArgumentParser(
        prog="mnemosyne timeline",
