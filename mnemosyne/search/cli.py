"""
CLI entry point for `mnemosyne search`.

Usage:
  mnemosyne search "query" [--agent AGENT] [--scope SCOPE] [--budget N] [--json]
...
from mnemosyne.search.hybrid import SearchResult, search


def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="mnemosyne search",
