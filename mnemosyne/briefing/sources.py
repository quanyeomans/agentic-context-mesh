...
_VAULT_ROOT = Path(os.environ.get("MNEMOSYNE_VAULT_ROOT", "/data/obsidian-vault"))
_WORKSPACE_ROOT = Path(os.environ.get("MNEMOSYNE_WORKSPACE_ROOT", "/data/workspaces"))
_ENTITIES_DB = Path(os.environ.get("MNEMOSYNE_ENTITIES_DB", "/data/mnemosyne/entities.db"))
_MEMORY_LOG_ROOT = Path(os.environ.get("MNEMOSYNE_MEMORY_LOG", "/data/workspaces"))
