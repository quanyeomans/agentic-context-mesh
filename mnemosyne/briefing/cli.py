"""
mnemosyne brief — session briefing synthesis.

Usage:
  mnemosyne brief <agent>

Generates a session briefing at /data/mnemosyne/briefing/<agent>-latest.md
...
def main(args: list[str] | None = None) -> None:
    """Entry point for `mnemosyne brief`."""
    import argparse

    if args is None:
        args = sys.argv[2:]  # strip 'mnemosyne brief'

    parser = argparse.ArgumentParser(
        prog="mnemosyne brief",
