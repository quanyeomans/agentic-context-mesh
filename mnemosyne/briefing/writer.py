...
Writes the generated briefing to /data/mnemosyne/briefing/<agent>-latest.md.
...
_BRIEFING_DIR = Path(os.environ.get("MNEMOSYNE_BRIEFING_DIR", "/data/mnemosyne/briefing"))
...
def write_briefing(
    ...
    """
    Write a briefing to /data/mnemosyne/briefing/<agent>-latest.md.
