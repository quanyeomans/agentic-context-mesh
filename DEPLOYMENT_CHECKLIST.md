...
Use this checklist when deploying Mnemosyne to a new a server environment, or after major infrastructure changes. Each item should be verified, not assumed.
