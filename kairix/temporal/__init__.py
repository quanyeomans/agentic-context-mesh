"""
kairix.temporal — Phase 2 date-aware chunking and query rewriting.
...
from kairix.temporal.chunker import TemporalChunk, chunk_board, chunk_file, chunk_memory_log
