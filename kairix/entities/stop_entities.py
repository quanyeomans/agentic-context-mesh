...
2. Run `kairix entity purge-noise` to clean existing DB rows
3. Update the changelog in 04-Agent-Knowledge/shared/kairix-ontology.md

See ontology doc for full rationale and rules:
  <vault-root>/agent-knowledge/shared/kairix-ontology.md
"""
