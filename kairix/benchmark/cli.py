...
def cmd_run(args: argparse.Namespace) -> int:
    from kairix.benchmark.runner import format_interpretation, run_benchmark
    from kairix.benchmark.suite import load_suite, validate_suite
...
def cmd_compare(args: argparse.Namespace) -> int:
    ...
    from kairix.benchmark.runner import CATEGORY_WEIGHTS, _score_tier
