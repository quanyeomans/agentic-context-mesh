...
def _run_generate(
    ...
    from kairix.summaries.generate import generate_summaries
    from kairix.summaries.staleness import write_summary
...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.all:
        ...
        from kairix.summaries.staleness import get_stale_paths
