...
## Current Results (Phase 3 — 2026-03-23)
...
| Temporal | 20% | 0.433 | Structural ceiling — date-aware chunking required (Phase 4) |
| Entity | 20% | 0.933 | Entity stubs + entity boost working correctly |
| Conceptual | 15% | 0.500 | Abstract queries partially resolved |
| Multi-hop | 10% | 0.480 | Connected retrieval requires Phase 4 planning layer |
...
Mnemosyne is production-ready for the use cases it covers (recall, entity lookup, session briefing, write classification). The Phase 3 weighted total of 0.762 represents a functional, well-tested system with known ceilings documented above.

Phase 4 work (date-aware chunking, connected retrieval, contradiction detection) is on the roadmap but not required for current agent workflows.
