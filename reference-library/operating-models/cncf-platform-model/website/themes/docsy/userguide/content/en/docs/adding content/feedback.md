...
1. Set the response text that users see after clicking **Yes** or **No**.
        ...
        [params.ui.feedback]
        enable = true
        yes = 'Glad to hear it! Please [tell us how we can improve](https://github.com/USERNAME/REPOSITORY/issues/new).'
        no = 'Sorry to hear that. Please [tell us how we can improve](https://github.com/USERNAME/REPOSITORY/issues/new).'
1. Save and close `config.toml`.
