---
title: "Discover community projects"
...
:::{grid-item-card} {fas}`globe;pst-color-primary`  Ecosystem
...
:::{grid-item-card} {fas}`puzzle-piece;pst-color-primary`  Community Extensions
...
:::{grid-item-card} {fas}`vial;pst-color-primary`  Community Samples
