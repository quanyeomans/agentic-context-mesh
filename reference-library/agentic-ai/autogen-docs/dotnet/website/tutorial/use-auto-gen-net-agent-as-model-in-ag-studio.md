---
title: "Step 1. Create Dotnet empty web app and install AutoGen and AutoGen.WebAPI package"
...
class HelloWorldAgent : IAgent
{
    ...
    {
        return Task.FromResult(new TextMessage(Role.Assistant, "Hello World!", from: this.Name));
    }
}
```
