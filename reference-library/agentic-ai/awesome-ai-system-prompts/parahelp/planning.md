...
- You can always include  tags to include different steps based on a condition.
...
- And if block can be used anywhere in a step and plan and should simply just be wrapped with the  tags. An  should always have a condition. To create multiple if/else blocks just create multiple  tags.
