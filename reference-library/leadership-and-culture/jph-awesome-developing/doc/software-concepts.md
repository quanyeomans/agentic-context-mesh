...
* [UBL](https://wikipedia.org/wiki/Universal_Business_Language) — Universal Business Language, National effort to define a royalty-free library of standard electronic XML business documents. All invoices to the Danish government have to be in UBL electronic format since February 2005.
...
* [WS-BPEL](https://wikipedia.org/wiki/WS-BPEL) — Web Services Business Process Execution Language
* [WSDM: Web Services Distributed Management](https://wikipedia.org/wiki/Web_Services_Distributed_Management)
* [WSDM](https://wikipedia.org/wiki/Web_Services_Distributed_Management) — Web Services Distributed Management
