...
var activeConnectionsCounter = meter.CreateUpDownCounter("active_connections", "connections", "Number of active connections");
```
...
meter.CreateObservableUpDownCounter("active_tasks", () =>
{
    ...
    return new[]
    {
        new Measurement(GetHighPriorityTaskCount(), new("priority", "high")),
        new Measurement(GetLowPriorityTaskCount(), new("priority", "low"))
    };
