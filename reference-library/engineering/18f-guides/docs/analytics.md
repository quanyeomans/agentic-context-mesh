...
| PDF downloads | Show that readers download guide content for print or email circulation. | [Google Analytics](https://analytics.google.com/analytics/web/?utm_source=marketingplatform.google.com&utm_medium=et&utm_campaign=marketingplatform.google.com%2Fabout%2Fanalytics%2F#/analysis/p393249053/edit/M4DQeEDfR8GKg6bBSojjqw) | Download the CSV results from the linked Google Analytics exploration and manually filter the documents you want to include in your count.  Only the de-risking guide is available in a PDF edition for download.  Other guide pages can be printed as a PDF. In particular, method cards include a “Print this card” button. However, our Google Analytics data doesn’t currently track this action. |
