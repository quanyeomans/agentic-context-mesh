...
## What’s in this guide
    ...
    <li class="usa-card tablet:grid-col-6">
          ...
          <p class="introduction_card_header">[Understanding and choosing a software solution]({{ ), which explains:</p>
          <ol>
    ...
    <li class="usa-card tablet:grid-col-6">
          ...
          <p class="introduction_card_header">[Four key principles for effective custom software development]({{ ):</p>
          <ol>
    ...
    <li class="usa-card tablet:grid-col-6">
          ...
          <p class="introduction_card_header">[Buying custom software development services]({{ ), including:</p>
          <ol>
    ...
    <li class="usa-card tablet:grid-col-6">
          ...
          <p class="introduction_card_header">[Working with a vendor development team]({{ ), including:</p>
          <ol>
