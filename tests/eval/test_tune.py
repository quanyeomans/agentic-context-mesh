"""Tests for kairix.quality.eval.tune — search parameter recommendations."""
...
class TestAnalyseResults:
    def test_identifies_weak_categories(self) -> None:
        from kairix.quality.eval.tune import analyse_results
...
class TestRecommend:
    def test_recommends_temporal_boost(self) -> None:
        from kairix.quality.eval.tune import CorpusHints, recommend
