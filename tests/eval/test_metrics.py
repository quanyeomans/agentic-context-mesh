...
class TestNdcg:
    ...
    def test_empty_gold(self):
        assert ndcg_score(["a.md"], [], k=10) == pytest.approx(0.0)

    @pytest.mark.unit
    def test_no_hits(self):
        assert ndcg_score(["x.md", "y.md"], ["a.md"], k=10) == pytest.approx(0.0)
    ...
    def test_cutoff_respected(self):
        ...
        assert score_k1 == pytest.approx(0.0)  # hit is beyond k=1
...
class TestHitAtK:
    ...
    def test_hit_first(self):
        assert hit_at_k(["a.md", "b.md"], ["a.md"], k=3) == pytest.approx(1.0)

    @pytest.mark.unit
    def test_hit_at_boundary(self):
        assert hit_at_k(["x.md", "y.md", "a.md"], ["a.md"], k=3) == pytest.approx(1.0)

    @pytest.mark.unit
    def test_miss_beyond_k(self):
        assert hit_at_k(["x.md", "y.md", "a.md"], ["a.md"], k=2) == pytest.approx(0.0)

    @pytest.mark.unit
    def test_empty_gold(self):
        assert hit_at_k(["a.md"], [], k=10) == pytest.approx(0.0)
...
class TestMrr:
    ...
    def test_no_hit(self):
        assert mean_reciprocal_rank(["x.md"], ["a.md"]) == pytest.approx(0.0)

    @pytest.mark.unit
    def test_empty_gold(self):
        assert mean_reciprocal_rank(["a.md"], []) == pytest.approx(0.0)
