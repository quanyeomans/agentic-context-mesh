...
# ---------------------------------------------------------------------------
# StoreHealthReport (VaultHealthReport is a backwards-compat alias)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# run_store_health — Neo4j unavailable
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# run_store_health — healthy Neo4j
# ---------------------------------------------------------------------------
...
def test_format_health_text_shows_issues() -> None:
    report = VaultHealthReport(
        ...
        organisation_count=5,
        person_count=5,
        issues=["2 organisation(s) missing vault_path — re-run store crawl"],
    )
    text = format_health_text(report)
