...
def test_fuzzy_match_returns_1_for_suffix_match() -> None:
    paths = ["04-Agent-Knowledge/entities/alex-jordan.md"]
    assert _fuzzy_match(paths, "entities/alex-jordan.md") == 1.0


def test_fuzzy_match_returns_0_for_no_match() -> None:
    paths = ["totally/unrelated/file.md"]
    assert _fuzzy_match(paths, "entities/alex-jordan.md") == 0.0
