...
class TestEntityRouting:
    def test_entity_person(self):
        path = resolve_target_path("builder", "entity", entity_type="person", entity_slug="alex-jordan")
        assert path == "/data/obsidian-vault/04-Agent-Knowledge/entities/person/alex-jordan.md"
