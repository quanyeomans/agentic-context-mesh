...
def test_exact_date_in_path_gets_boosted() -> None:
    ...
    out = temporal_date_boost(results, query="2026-03-22 decisions")
...
def test_year_month_prefix_match_gets_boosted() -> None:
    ...
    out = temporal_date_boost(results, query="2026-03-22 standup notes")
...
def test_non_matching_date_not_boosted() -> None:
    ...
    out = temporal_date_boost(results, query="2026-03-22 Docker sandbox")
...
def test_relative_temporal_boosts_recent_paths() -> None:
    ...
    out = temporal_date_boost(results, query="what happened recently")
...
def test_empty_results_returns_empty_no_error() -> None:
    ...
    out = temporal_date_boost([], query="2026-03-22 standup")
    assert out == []
...
def test_no_date_in_query_and_no_relative_term_unchanged() -> None:
    ...
    out = temporal_date_boost(results, query="Docker sandbox setup")
...
def test_path_without_date_unaffected_when_explicit_date_in_query() -> None:
    ...
    out = temporal_date_boost(results, query="2026-04-05 Docker sandbox")
...
def test_boost_factor_is_multiplicative() -> None:
    ...
    out = temporal_date_boost(results, query="2026-03-22")
...
def test_year_month_only_query_boosts_matching_paths() -> None:
    ...
    out = temporal_date_boost(results, query="what happened in 2026-03")
