...
VALID_QMD_OUTPUT: list[dict] = [
    {
        "file": "/data/obsidian-vault/04-Agent-Knowledge/shared/facts.md",
        "title": "Shared Facts",
    ...
    {
        "file": "/data/obsidian-vault/04-Agent-Knowledge/builder/patterns.md",
...
class TestNormaliseFtsQuery:
    def test_removes_stop_words(self) -> None:
        result = _normalise_fts_query("what do we know about Alex Jordan")
    ...
    def test_replaces_hyphens_with_spaces(self) -> None:
        result = _normalise_fts_query("tc-productivity")
    ...
    def test_preserves_meaningful_terms(self) -> None:
        result = _normalise_fts_query("tell me about Triad Consulting as an organisation")
    ...
    def test_openclaw_platform(self) -> None:
        result = _normalise_fts_query("who is the OpenClaw platform built for")
        tokens = result.split()
